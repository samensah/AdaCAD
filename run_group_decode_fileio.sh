...
# core_lm_name="specify_in_input_jsonl|mistralai/Mistral-7B-Instruct-v0.3", microsoft/Phi-4-mini-instruct # facebook/opt-1.3b, google/flan-t5-xl, etc.
core_lm_name="specify_in_input_jsonl|microsoft/Phi-4-mini-instruct"
